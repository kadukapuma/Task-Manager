        ...
        <div className="task-form-col">
          ...
          {isAdmin && (
            <>
              ...
              {form.is_repeating && (
                <div className="form-field">
                  <label id="task_freq_label">Repeat Frequency</label>
                  <div
                    className={`freq-option-group ${fieldClass('repeat_frequency', Boolean(form.repeat_frequency))}`}
                    role="radiogroup"
                    aria-labelledby="task_freq_label"
                  >
                    {FREQUENCIES.map((f) => (
                      <button
                        key={f}
                        type="button"
                        role="radio"
                        aria-checked={form.repeat_frequency === f}
                        className={`freq-option ${form.repeat_frequency === f ? 'is-selected' : ''}`}
                        onClick={() => {
                          set('repeat_frequency', f)
                          touch('repeat_frequency')
                        }}
                      >
                        {f}
                      </button>
